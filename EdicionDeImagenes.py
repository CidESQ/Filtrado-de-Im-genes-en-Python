...
def aplicar_kernel(kernel):
    ...
    imagen_filtrada_bgr = cv2.cvtColor(imagen_filtrada_rgb, cv2.COLOR_RGB2BGR)
    return imagen_filtrada_bgr


cv2.imshow("Imagen original", imagen)
cv2.imshow("Imagen Filtrada (blur)", aplicar_kernel(kernel_1))
# Interfaz Grafica
# figura = plt.figure()
# # Imagen Principal
